...
// Serve static frontend files (index.html, app.js, style.css) from the current folder
...
// Route root URL explicitly to index.html
app.get('/', (req, res) => {
...
app.listen(PORT, () => {
    console.log(`================================================`);
    console.log(`A.E.G.I.S. System Bridge Online (Launch & Close)`);
